...
function animateFireworks() {
  ...
  // หยุด Animation Loop เองเมื่อไม่มีอนุภาคเหลือแล้ว เพื่อประหยัดพลังงานเครื่อง
  if (particles.length === 0 && explosionStartTime !== null) {
...
function startFinale() {
  // ขั้น 1: หัวใจดวงใหญ่ค่อย ๆ ปรากฏขึ้นกลางจอ
